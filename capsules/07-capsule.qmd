...
[Télécharger le script R de la vidéo](www/capsule_7.R) (Faire boutton droit -> enregistrer sous...)
...
check_question(
  ...
  right = "Le paramètre numérique `cex` permet de changer la taille des points (ex.: `plot(1, cex = 12)`.",
  wrong = "Utilisez l'aide de R pour trouver le bon paramètre à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Le paramètre numérique `pch` permet de changer le symbole des points (ex.: `plot(1, pch = 22)`).",
  wrong = "Utilisez l'aide de R pour trouver le bon paramètre à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Le paramètre `col` permet de changer la couleur de remplissage des barres (ex.: `barplot(1, col = 'red')`).",
  wrong = "Utilisez l'aide de R pour trouver le bon paramètre à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Les paramètres `xlab` et `ylab` permettent de changer le nom des axises (ex.: `plot(1, xlab = 'yolo', ylab = 'lol')`).",
  wrong = "Utilisez l'aide de R pour trouver le bon paramètre à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Le paramètre `main` permet de changer le titre d'un graphique (ex.: `hist(rnorm(100), main = 'Mon super titre')`).",
  wrong = "Utilisez l'aide de R pour trouver le bon paramètre à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "La fonction `abline()` permet d'ajouter une droite à un graphique (ex.: `plot(1); abline(a = 0, b = 1)`).",
  wrong = "Utilisez l'aide de R pour trouver la bonne fonction à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Le paramètre `lwd` (*line width*) permet de changer l'épaisseur d'une ligne dans un graphique (ex.: `plot(1:100, type = 'l', lwd = 10)`).",
  wrong = "Utilisez l'aide de R pour trouver le bon paramètre à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Les fonctions `points()` et `lines()` permettent d'ajouter plusieurs séries de données dans un graphique (ex.: `plot(1:10, 1:10); lines(1:10, 1:10*2)`).",
  wrong = "Regardez les exemples dans l'aide de R (`?plot`) pour vous aider.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "Les fonctions `par()` et `mfrow()` permettent permettent de contrôler comment plusieurs graphiques sont présentés sur une page.",
  wrong = "Utilisez l'aide de R (`?par`) pour trouver la bonne fonction à utiliser.",
...
check_question(
  ...
  type = "checkbox",
  button_label = "Vérifier",
  right = "La fonction `mar()` permet de contrôler l'espace autours d'un graphique. (ex.: `par(mar = c(20, 3, 3, 3)); plot(1)`).",
  wrong = "Utilisez l'aide de R pour trouver la bonne fonction à utiliser.",
...
# add axis
axis(2,
  at = c(1, 2, 3, 4, 5, 6), labels = c("pch", "col", "cex", "lty", "type", "lwd"),
...
plot(
  ...
  1:10,
  xlab = bquote(x ^ 2),
  ylab = bquote("Primary production" ~ (mgC ~ m ^ {-1})),
...
- [Télécharger la documentation sous format PDF](www/capsule_7.pdf)
- [Télécharger la documentation sous format HTML](www/capsule_7.html)
