...
<!-- sondage_bio1006 <- read.csv("BIO1006_H2018_Echantillon.csv") -->
<!-- ``` -->

<!-- ```{r echo=FALSE, eval=TRUE} -->
<!-- sondage_bio1006 <- read.csv("www/BIO1006_H2018_Echantillon.csv") -->
<!-- head(sondage_bio1006) -->
<!-- ``` -->

<!-- <div class="alert alert-info"> -->
<!--   <strong>Info!</strong> N'oubliez de changer le chemin d'accès pour lire le fichier `BIO1006_H2018_Echantillon.csv` qui se trouve sur votre ordinateur. -->
<!-- </div> -->
...
<!-- ```{r, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, dev='jpeg', fig.width=6, fig.height=6, fig.align='center'} -->
<!-- x <- rnorm(1000) -->
<!-- hist(x, main = "Format matriciel", col = "cornflowerblue") -->
<!-- ``` -->

<!-- ```{r, eval=TRUE, message=FALSE, echo=FALSE, dev='svg', fig.width=6, fig.height=6, fig.align='center'} -->
