...
check_question(
  ...
  right = "**Correct!**",
  wrong = "Vous êtes proche! Les fonctions ont rarement un nom en français.",
...
check_question(
  ...
  wrong = "Le paramètre `trim` à une valeur par défaut égale à `0`. Il n'est pas obligatoire de lui spécifier une valeur. Le paramètre `na.rm` à une valeur par défaut égale à `FALSE`. Il n'est pas obligatoire de lui spécifier une valeur.",
